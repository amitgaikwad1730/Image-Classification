# -*- coding: utf-8 -*-
"""
Created on Fri Dec 13 22:34:51 2019
...
catImages = os.listdir('C:/Users/Dell/Project/Dogs & Cat Classification/training_set/cats')
print ("Number of Cat images - ",str(len(catImages)))

dogImages = os.listdir('C:/Users/Dell/Project/Dogs & Cat Classification/training_set/dogs')
print ("Number of Dog images - ",str(len(dogImages)))


dogFilename = 'C:/Users/Dell/Project/Dogs & Cat Classification/training_set/dogs/'+dogImages[2]
dimage = Image.open(dogFilename)
dimage

catFilename = 'C:/Users/Dell/Project/Dogs & Cat Classification/training_set/cats/'+catImages[2]
